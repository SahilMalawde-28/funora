...
export default function Groups({
  ...
  return (
    <div className="relative w-full h-[80vh] max-h-[900px] bg-white rounded-3xl shadow-2xl border overflow-hidden">
      ...
      // ... (omitting unchanged code above the mobile section)
...
<div className="md:hidden flex flex-col h-full">
  ...
  >
    <div
      // *** FIX: Set container width to 300% to hold three full-width panels ***
    ...
    >
      ...
      {/* ----------------------------------
          PANEL 0 — GROUPS LIST
      ----------------------------------- */}
      {/* *** FIX: Set panel width to 1/3 (33.333333%) of the 300% container *** */}
